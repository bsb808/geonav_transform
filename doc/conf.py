...
project = u'geonav_transform'
copyright = u'2017, Brian Bingham'
...
htmlhelp_basename = 'geonav_transformdoc'
...
latex_documents = [
  ('index', 'geonav_transform.tex', u'geonav\\_transform Documentation',
   u'Brian Bingham', 'manual'),
]
...
man_pages = [
    ('index', 'geonav_transform', u'geonav_transform Documentation',
     [u'Brian Bingham'], 1)
]
...
texinfo_documents = [
  ('index', 'geonav_transform', u'geonav_transform Documentation',
   u'Brian Bingham', 'geonav_transform', 'One line description of project.',
   'Miscellaneous'),
]
